...
module.exports = {
  up: (queryInterface, Sequelize) => {
    ...
    .then(() => queryInterface.createTable('IdentityProviderMyPayRelations', {
      id: {
        allowNull: false,
        primaryKey: true,
        type: Sequelize.STRING
    ...
    .then(() => queryInterface.createTable('Businesses', {
        id: {
            allowNull: false,
            primaryKey: true,
            type: Sequelize.STRING
    ...
    .then(() => queryInterface.createTable('Clients', {
        id: {
          allowNull: false,
          primaryKey: true,
          type: Sequelize.STRING
    ...
    .then(() => queryInterface.createTable('Merchants', {
        id: {
          allowNull: false,
          primaryKey: true,
          type: Sequelize.STRING
    ...
    .then(() => queryInterface.createTable('Relationships', {
        id: {
          allowNull: false,
          primaryKey: true,
          type: Sequelize.STRING
